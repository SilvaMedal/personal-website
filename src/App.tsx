      ...
      <main className="main">
        ...
        <section id="about" className="section">
          ...
          <p className="revealing-text delay-4">
            ...
            ullamcorper morbi tincidunt ornare massa. Aliquet nec ullamcorper
            sit amet risus nullam eget felis eget. Orci nulla pellentesque
            dignissim enim sit amet venenatis. Viverra aliquet eget sit amet
            tellus. Enim blandit volutpat maecenas volutpat blandit aliquam
            etiam. Congue eu consequat ac felis donec et odio pellentesque.{" "}
          </p>
        </section>
        <section id="portfolio" className="section">
          <h3 className="revealing-text delay-4">Portfolio Section</h3>
          <p className="revealing-text delay-4">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua. Lectus
            proin nibh nisl condimentum id venenatis a condimentum. Lorem donec
        ...
        <section id="resources" className="section">
          <h3 className="revealing-text delay-4">Resources Section</h3>
          <p className="revealing-text delay-4">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua. Lectus
            proin nibh nisl condimentum id venenatis a condimentum. Lorem donec
