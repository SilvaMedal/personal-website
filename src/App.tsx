      ...
      <main className="main">
        ...
        <div className="revealing-text delay-4">
          <section id="about" className="section">
            <h3>About Me:</h3>
            <p>
              Hi, I'm Anthony Silva, a freelance web developer driven by an
              insatiable thirst for knowledge. With over 16 years of experience
              in the dynamic world of hospitality, primarily in restaurant
              management, I transitioned into the realm of web development 2.5
              years ago.{" "}
            </p>
            <p>
              ...
              tech industry. My journey has been a testament to my dedication to
              personal growth and my commitment to fostering tech innovation.
            </p>
          </section>
